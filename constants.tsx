...
export const SERVICE_BAR_HIGHLIGHTS = [
  {
    icon: 'Sparkles',
    label: { en: 'Colombian Expertise', es: 'Experiencia Colombiana' }
  },
  {
    icon: 'Gem',
    label: { en: 'Premium Treatments', es: 'Tratamientos Premium' }
  },
  {
    icon: 'CheckCircle2',
    label: { en: 'Real Results', es: 'Resultados Reales' }
  },
  {
    icon: 'User',
    label: { en: 'Personalized Care', es: 'Atención Personalizada' }
  }
];
