...
const Footer: React.FC<FooterProps> = ({ lang }) => {
  ...
  return (
    <>
      <footer className="bg-[#0a0a0a] text-white pt-40 pb-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center mb-10">
                <img
                  ...
                  className="h-32 w-auto object-contain brightness-0 invert opacity-90 hover:opacity-100 transition-opacity"
                />
              </div>
              <p className="text-gray-400 max-w-sm mb-12 leading-relaxed font-light text-xl">
                {lang === 'en'
              ...
              <div className="flex space-x-8 text-[11px] font-black tracking-[0.4em] text-[#56b4bd] uppercase">
          ...
          <div className="pt-16 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-[11px] text-gray-500 font-bold uppercase tracking-[0.2em]">
            <p className="mb-6 md:mb-0">© {new Date().getFullYear()} Divine Aesthetics Spa. Saint Augustine, FL.</p>
            <div className="space-x-10">
              <button
                onClick={() => setShowPrivacy(true)}
                className="hover:text-[#56b4bd] transition-all cursor-pointer opacity-70 hover:opacity-100"
              >
