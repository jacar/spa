...
const Hero: React.FC<HeroProps> = ({ lang, previewData }) => {
  ...
  const heroData = previewData || content?.hero || {
    ...
    backgroundImage: 'https://www.webcincodev.com/blog/wp-content/uploads/2026/02/Gemini_Generated_Image_83n1ft83n1ft83n1-1-scaled.png'
  };

  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-x-hidden bg-[#faf9f6]">
